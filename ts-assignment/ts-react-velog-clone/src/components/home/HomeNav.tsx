...
const HomeNav = () => {
  ...
  return (
    <StyledRoot isArticleBottomLine={isArticleBottomLine}>
      <Link to="/" id="article" onClick={handleClick}>
        글
      </Link>
      <Link to="/series" id="series" onClick={handleClick}>
        시리즈
      </Link>
...
const StyledRoot = styled.nav<{ isArticleBottomLine: boolean }>`
  width: 100%;
  display: flex;
...
const StyledBottomLine = styled.div<{ isArticleBottomLine: boolean }>`
